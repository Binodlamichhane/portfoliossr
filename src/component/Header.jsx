      ...
      <div className=" w-full h-20  flex sticky top-0 bg-zinc-600  z-20 ">
        <div className=" w-[100%]  md:px-0 md:w-3/4 flex m-auto  justify-between items-center ">
         ...
         <div className=" md:hidden mr-3 md:mr-0">
          <FontAwesomeIcon className=" text-xl" onClick={()=>{showNavigation(!navigation)}} size="2x" icon={faList} />
        </div>
...
{navigation &&<aside id="default-sidebar" className="fixed top-0 right-0 z-40 w-64 h-screen transition-transform -translate-x-full translate-x-0" aria-label="Sidebar">
   <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
      <ul class="space-y-2 font-medium">
         ...
         <li>
            <Link to="#one" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
         ...
         <li>
            <Link to="/blog" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
         ...
         <li>
            <Link to="/resume" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">
                  <path d="M17 5.923A1 1 0 0 0 16 5h-3V4a4 4 0 1 0-8 0v1H2a1 1 0 0 0-1 .923L.086 17.846A2 2 0 0 0 2.08 20h13.84a2 2 0 0 0 1.994-2.153L17 5.923ZM7 9a1 1 0 0 1-2 0V7h2v2Zm0-5a2 2 0 1 1 4 0v1H7V4Zm6 5a1 1 0 1 1-2 0V7h2v2Z"/>
               </svg>
               <span class="flex-1 ms-3 whitespace-nowrap">Resume</span>
            </Link>
         </li>
         <li>
            <Link to="/service" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
          ...
          {signin && (
            <form
              className="absolute top-[15vh]  left-1/2 -translate-x-1/2 border   p-4 md:p-8 md:px-11 rounded-lg bg-slate-200"
          ...
          {login && (
            <form
              ...
              className="absolute top-[20vh]  left-1/2 -translate-x-1/2 border p-4 md:p-8 md:px-11 rounded-lg bg-slate-200"
            >
              <label
